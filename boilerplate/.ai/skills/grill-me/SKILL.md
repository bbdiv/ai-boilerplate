...
name: grill-me
description: >-
  Stress-test a plan or design via relentless interview before implementation.
  Walk the decision tree, ask one question at a time, recommend an answer for
  each. Use when the user wants their plan grilled, says "grill me", or kicks
  off a non-trivial feature without an aligned plan.
