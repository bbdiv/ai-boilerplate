---
description: >-
  Manage i18n translation keys, locale JSON files, and the TypeScript type that keeps them type-safe. Apply when adding, editing, or removing translation keys or locale files.
---
