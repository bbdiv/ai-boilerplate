---
description: >-
  Enforce grouped and ordered imports in all code files. Apply whenever creating or editing any file that contains imports so they stay consistent and easy to review.
---
