---
description: >-
  Author a new skill in `.ai/skills/` following project conventions. Use when the user wants to create, write, or scaffold a new skill, or when a recurring task in this codebase needs a reusable recipe.
---
